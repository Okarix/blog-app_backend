...
export const commentCreateValidation = [body('text').notEmpty().withMessage('Enter a comment fot the post'), body('text').isLength({ max: 500 }).withMessage('Max 500 symbols')];
